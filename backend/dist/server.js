        ...
        fastify.register(mercurius, {
            ...
            resolvers: {
                Query: {
                    ...
                    lot: (_, { id }) => lotService.getLot(id),
                },
                Mutation: {
                    registerLot: (_, args) => lotService.registerLot(args),
                    submitVerification: (_, args) => lotService.submitVerification(args.lotId, {
                        method: args.method,
                        verifier: args.verifier,
                        notes: args.notes,
                    }),
                    tokenizeLot: (_, args) => lotService.tokenizeLot(args.lotId, {
                        symbol: args.symbol,
                        supply: args.supply,
                    }),
                },
