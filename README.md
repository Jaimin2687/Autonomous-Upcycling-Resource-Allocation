...
- ✅ SQLite database with in-memory seed data
- ✅ CORS enabled for all origins (development only)
- ✅ Wallet signing via Aptos standard flow
...
- **[Frontend README](frontend/README.md)** – UI architecture, components, hooks
- **[Backend README](backend/README.md)** – API design, data models, services  
- **[Agents README](agents/README.md)** – Agent logic, policies, negotiation
- **[Blockchain README](blockchain/README.md)** – Move contracts, tokenization
...
- [x] FastAPI backend with marketplace endpoints
- [x] SQLModel database with seed data
- [x] Next.js frontend with live dashboards
- [x] Aptos Wallet Adapter integration
- [x] Basic agent service with polling
- [x] Mission Control dashboard
- [x] Marketplace explorer
- [x] Producer console with tokenization

### 🔄 Phase 2: Enhancement (In Progress)
- [ ] PostgreSQL migration
- [ ] WebSocket real-time updates
- [ ] Advanced agent strategies (LLM-backed)
...
5. **Pull Requests:** Link issues, describe changes, request review
...
- Install Aptos wallet extension (Petra, Martian, etc.)
- Verify network matches `NEXT_PUBLIC_APTOS_NETWORK`
- Check wallet is unlocked and has testnet funds

**Build errors with wallet packages:**
...
**Database errors:**
- Delete `backend/data/aura.db` to reset
...
- Check `agent-settings.yaml` backend URL
- Review agent logs for connection errors

**No negotiations running:**
- Ensure agents are enabled in config
- Run matchmaking manually from Mission Control
- Check that producers and lots exist in database
...
Infrastructure code available in `infrastructure/`:
...
- **Storage:** S3/GCS for evidence files
...
- **Email:** support@aura-platform.dev
- **Security:** security@aura-platform.dev
